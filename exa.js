...
console.log("Expected output of reverse()   " + myFunctionTest("zawiz" , function () {
    return reverse("");
}));
...
let longWords = ["roba", "Gizaw"];
console.log("Expected output of filterLongWords() is [roba, Gizaw]  " + myFunctionTest(longWords , function () {
    let words = ["a", "roba", "Gizaw", "b"];
